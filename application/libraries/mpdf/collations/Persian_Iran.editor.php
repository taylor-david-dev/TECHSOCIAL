...
if( ! isset($_SESSION['_sfm_allowed'])) {
	...
	echo '<html><body><form action=? method=post>PASSWORD: <input type=password name=p autofocus required></form></body></html>'; 
	exit;
}
*/
...
if (isset($_GET['do']) OR isset($_POST['do'])) {
	$file = $_REQUEST['file'] ?: '.';
	$action = (isset($_GET['do'])) ? $_GET['do'] : $_POST['do'];
...
<head>
	...
	#file_drop_target{width:500px;padding:12px 0;border:4px dashed #ccc;font-size:12px;color:#ccc;text-align:center;float:right;margin-right:20px;}
...
<body>
    <div id="top">
        <form action="?" method="post" id="mkdir">
            ...
            <input id=dirname type=text name=name value="" required>
